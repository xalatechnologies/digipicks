 ...
 * - Inside @digipicks/ds package itself (DS components legitimately use raw HTML)
 *
...
const FORBIDDEN_ELEMENTS = {
  p: 'Use <Paragraph> from @digipicks/ds instead of <p>.',
  h1: 'Use <Heading level={1}> from @digipicks/ds instead of <h1>.',
  h2: 'Use <Heading level={2}> from @digipicks/ds instead of <h2>.',
  h3: 'Use <Heading level={3}> from @digipicks/ds instead of <h3>.',
  h4: 'Use <Heading level={4}> from @digipicks/ds instead of <h4>.',
  h5: 'Use <Heading level={5}> from @digipicks/ds instead of <h5>.',
  h6: 'Use <Heading level={6}> from @digipicks/ds instead of <h6>.',
  ...
  button: 'Use <Button> from @digipicks/ds instead of <button>.',
  input: 'Use <Textfield>, <Checkbox>, or <Radio> from @digipicks/ds instead of <input>.',
  select: 'Use <Select> or <NativeSelect> from @digipicks/ds instead of <select>.',
  textarea: 'Use <Textarea> from @digipicks/ds instead of <textarea>.',
  table: 'Use <DataTable> or DS Table from @digipicks/ds instead of <table>.',
  fieldset: 'Use <Fieldset> from @digipicks/ds instead of <fieldset>.',
};
...
export default {
  meta: {
    type: 'problem',
    docs: {
      description: 'Prevent raw HTML elements that have DS equivalents. Use Paragraph, Heading, Label, etc.',
