...
export type ComponentApi<Name extends string | undefined = string | undefined> = {
  ...
  mutations: {
    ...
    assignMediator: FunctionReference<
      ...
      Name
    >;
    changeStatus: FunctionReference<'mutation', 'internal', { id: string; status: string }, { success: boolean }, Name>;
  ...
  queries: {
    getDispute: FunctionReference<'query', 'internal', { id: string }, any, Name>;
    getDisputeCounts: FunctionReference<'query', 'internal', { tenantId: string }, any, Name>;
