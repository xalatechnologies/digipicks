...
export type ComponentApi<Name extends string | undefined = string | undefined> = {
  functions: {
    ...
    createTier: FunctionReference<
      ...
      Name
    >;
    getCreatorAccount: FunctionReference<'query', 'internal', { userId: string }, any, Name>;
    getCreatorAccountByStripeId: FunctionReference<'query', 'internal', { stripeAccountId: string }, any, Name>;
    getMembership: FunctionReference<'query', 'internal', { id: string }, any, Name>;
    getMembershipByStripeSubscription: FunctionReference<
      ...
      Name
    >;
    getMembershipByUser: FunctionReference<'query', 'internal', { userId: string }, any, Name>;
    getMembershipByUserAndCreator: FunctionReference<
      ...
      Name
    >;
    getMembershipStats: FunctionReference<'query', 'internal', { tenantId: string }, any, Name>;
    getTier: FunctionReference<'query', 'internal', { id: string }, any, Name>;
    getTierBySlug: FunctionReference<'query', 'internal', { slug: string; tenantId: string }, any, Name>;
    getTrialStatus: FunctionReference<'query', 'internal', { creatorId: string; userId: string }, any, Name>;
    ...
    listCreatorSubscribers: FunctionReference<
      ...
      Name
    >;
    listDueForRenewal: FunctionReference<'query', 'internal', { beforeDate: number }, Array<any>, Name>;
    listExpiringTrials: FunctionReference<'query', 'internal', { beforeDate: number }, Array<any>, Name>;
