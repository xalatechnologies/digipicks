...
export type ComponentApi<Name extends string | undefined = string | undefined> = {
  functions: {
    ...
    creatorStatsBySport: FunctionReference<
      ...
      Name
    >;
    get: FunctionReference<'query', 'internal', { id: string; tenantId?: string }, any, Name>;
    grade: FunctionReference<
      ...
      Name
    >;
    isTailed: FunctionReference<'query', 'internal', { pickId: string; userId: string }, boolean, Name>;
    ...
    list: FunctionReference<
      ...
      Name
    >;
    listPickCollaborators: FunctionReference<'query', 'internal', { pickId: string }, Array<any>, Name>;
