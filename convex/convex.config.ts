...
// DigiPicks: creatorApplications (creator onboarding + verification workflow)
import creatorApplications from './components/creatorApplications/convex.config';
app.use(creatorApplications);
