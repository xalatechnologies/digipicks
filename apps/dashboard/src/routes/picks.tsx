...
import { usePicks, useCreatorStats, useDeletePick, useGradePick, type PickType } from '@digilist-saas/sdk';
...
export function PicksPage() {
    ...
    const columns: DataTableColumn<PickType>[] = useMemo(() => [
        ...
        },
        {
            ...
            render: (pick) => <Tag data-size="sm" data-color="neutral">{pick.sport}</Tag>,
        },
        {
            id: 'selection',
        ...
        },
        {
            ...
            render: (pick) => (
                <span>
                    ...
                    <span style={{ fontSize: 'var(--ds-size-2)', color: 'var(--ds-color-text-subtle)', marginLeft: 'var(--ds-size-1)' }}>
        ...
        },
        {
            ...
            render: (pick) => pick.result === 'pending' ? (
                <NativeSelect
                    data-size="sm"
                    defaultValue=""
                    onChange={(e) => {
                        ...
                        <Card>
                            <div className={styles.statCard}>
                                ...
                                <div className={styles.statLabel}>
                                    {t('picks.stats.total', 'Total Picks')}
                                </div>
                            </div>
                        </Card>
                        <Card>
                            <div className={styles.statCard}>
                                ...
                                <div className={styles.statLabel}>
                                    {t('picks.stats.winRate', 'Win Rate')}
                                </div>
                            </div>
                        </Card>
                        <Card>
                            <div className={styles.statCard}>
                                <div className={styles.statValue} style={{ color: stats.netUnits >= 0 ? 'var(--ds-color-success-text-default)' : 'var(--ds-color-danger-text-default)' }}>
                                    {stats.netUnits >= 0 ? '+' : ''}{stats.netUnits.toFixed(1)}u
                                </div>
                                <div className={styles.statLabel}>
                                    {t('picks.stats.netUnits', 'Net Units')}
                                </div>
                            </div>
                        </Card>
                        <Card>
