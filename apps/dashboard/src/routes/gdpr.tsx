...
import { useAuthBridge, useSetPageTitle, useTenantContext } from '@digilist-saas/app-shell';
...
export function GDPRPage() {
    ...
    return (
        <PageContentLayout>
            <DashboardPageHeader
                subtitle={t('gdpr.subtitle', 'Datautlevering og sletting i henhold til GDPR')}
            />

            <Stack direction="vertical" spacing="var(--ds-size-5)">
                {/* Feedback */}
                {feedback && (
                    <Alert data-color={feedback.type}>
                        {feedback.message}
                    </Alert>
                )}
                ...
                <Card>
                    <Stack direction="vertical" spacing="var(--ds-size-4)">
                        ...
                        <Paragraph data-size="sm">
                            Eksporter alle personopplysninger for en bruker som JSON-fil.
                        </Paragraph>
                        ...
                        {exportData && (
                            <Stack direction="vertical" spacing="var(--ds-size-3)">
                                <Alert data-color="info">
                                    Data funnet: {(exportData as any)?.user?.email || 'Ukjent bruker'}
                                </Alert>
                                <Button
                                    type="button"
                                    variant="secondary"
                ...
                <Card>
                    <Stack direction="vertical" spacing="var(--ds-size-4)">
                        ...
                        <Alert data-color="warning">
                            Denne handlingen anonymiserer brukerens personopplysninger. Ordrehistorikk og finansielle data beholdes av lovmessige aarsaker.
                        </Alert>
                    ...
                    <Card>
                        <Stack direction="vertical" spacing="var(--ds-size-4)">
                            ...
                            <Alert data-color="danger">
                                ADVARSEL: Denne handlingen sletter all data for denne tenanten, inkludert alle brukere. Denne handlingen kan ikke angres.
                            </Alert>
                            ...
                            {!showTenantPurge ? (
                                <Button
                                    ...
                                    variant="secondary"
                                    data-color="danger"
                                    onClick={() => setShowTenantPurge(true)}
                                >
                                ...
                                <Stack direction="vertical" spacing="var(--ds-size-3)">
                                    <Field>
                                        ...
                                        <Paragraph data-size="xs">
                                            Kontakt systemadmin for bekreftelseskoden.
                                        </Paragraph>
                                    </Field>
                                    ...
                                    <Stack direction="horizontal" justify="end" spacing="var(--ds-size-3)">
                                        <Button
                                            type="button"
                                            variant="secondary"
                                            onClick={() => { setShowTenantPurge(false); setConfirmCode(''); }}
                                        >
                                            Avbryt
                                        </Button>
                                        <Button
