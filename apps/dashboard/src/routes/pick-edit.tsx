...
import { usePick, useCreatePick, useUpdatePick, type PickCategory, type Confidence } from '@digipicks/sdk';
  ...
  return (
    <PageContentLayout>
      <div className={styles.page}>
        ...
        {error && <ErrorState title={t('picks.error', 'Error')} message={error} />}
        ...
        <Card>
          <div className={styles.formCard}>
            ...
            <div className={styles.formSection}>
              ...
              <div className={styles.formRow}>
                <Textfield
                  ...
                  required
                />
                <NativeSelect label="Sport" value={sport} onChange={(e) => setSport(e.target.value)}>
                  {SPORTS.map((s) => (
            ...
            <div className={styles.formSection}>
              ...
              <div className={styles.formRow}>
                <NativeSelect label="Pick Type" value={pickType} onChange={(e) => setPickType(e.target.value)}>
                  {PICK_TYPES.map((pt) => (
            ...
            <div className={styles.actions}>
              ...
              <Button variant="primary" onClick={handleSave} disabled={!isValid || saving}>
                {saving
                  ? isEditing
                    ? t('picks.saving', 'Saving...')
                    : t('picks.creating', 'Creating...')
                  : isEditing
                    ? t('picks.save', 'Save Changes')
                    : t('picks.publish', 'Publish Pick')}
              </Button>
            </div>
          </div>
        </Card>
