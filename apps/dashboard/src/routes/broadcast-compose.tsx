...
import { useSendBroadcast } from '@digipicks/sdk';
  ...
  return (
    <PageContentLayout>
      <div className={styles.page}>
        <Heading data-size="md">{t('broadcasts.compose', 'New Broadcast')}</Heading>
        ...
        <Card className={styles.composerForm}>
          ...
          <div className={styles.composerActions}>
            <Button variant="secondary" data-size="sm" onClick={() => navigate('/broadcasts')}>
              {t('common.cancel', 'Cancel')}
            </Button>
            <Button data-size="sm" onClick={handleSend} disabled={!canSend || sending} loading={sending}>
