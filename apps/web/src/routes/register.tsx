...
export function RegisterPage(): React.ReactElement {
    ...
    const showEmailAvailability =
        debouncedEmail.includes('@') && emailCheck !== undefined && emailCheck !== null;
                ...
                <Card style={{ padding: 'var(--ds-size-6)' }}>
                    <Stack direction="vertical" spacing="var(--ds-size-5)" align="center">
                        ...
                        <Paragraph data-size="md" style={{ textAlign: 'center', color: 'var(--ds-color-neutral-text-subtle)' }}>
                            {isOwnerIntent
                                ? t('web.register.ownerNextStep', 'Flott! Nå kan du søke om utleiertilgang. Vi sender deg videre til søknadsskjemaet.')
                        ...
                        {isOwnerIntent ? (
                            <>
                                ...
                                <Button
                                    ...
                                    data-size="lg"
                                    style={{ width: '100%' }}
                                    onClick={() => { window.location.href = '/apply-owner'; }}
                                >
                ...
                <>
                    ...
                    {phoneSent && (
                        <Alert data-color="info" className={regStyles.inlineAlert}>
                            <Heading level={3} data-size="xs">{t('web.register.phoneSentTitle', 'Kommer snart')}</Heading>
                            <Paragraph data-size="sm">
                                {t('web.register.phoneSentDesc', 'SMS-registrering er under utvikling. Bruk en av de andre metodene for å komme i gang.')}
                            </Paragraph>
                            <Button variant="secondary" data-size="sm" onClick={() => { setShowPhone(false); setPhoneSent(false); }}>
                    ...
                    {showMagicLink && !requestSuccess && (
                        <Card className={regStyles.inlineFormCard}>
                            ...
                            <Paragraph data-size="sm" className={regStyles.formParagraphSubtle}>
                                {t('web.register.magicLinkFormDesc', 'Vi sender deg en lenke du kan bruke til å logge inn — ingen passord nødvendig.')}
                            </Paragraph>
                    ...
                    {requestSuccess && (
                        <Alert data-color="success" className={regStyles.inlineAlert}>
                            <Heading level={3} data-size="xs">{t('web.register.checkEmail', 'Sjekk e-posten din')}</Heading>
                            <Paragraph data-size="sm">
                                {t('web.register.magicLinkSent', `Vi har sendt en innloggingslenke til ${magicLinkEmail}.`)}
                            </Paragraph>
                            <Button variant="secondary" data-size="sm" onClick={() => { setShowMagicLink(false); setMagicLinkEmail(''); }}>
                                {t('common.back', 'Tilbake')}
                            </Button>
                        </Alert>
                    )}
                    ...
                    {!showEmailForm ? (
                        <Button
                            variant="secondary"
                            className={regStyles.fullWidthButton}
                                ...
                                <Stack direction="vertical" spacing="var(--ds-size-4)">
                                            ...
                                            <Paragraph
                                                ...
                                                className={
                                                    emailCheck.available
                                                        ? regStyles.emailStatusAvailable
                                                        : regStyles.emailStatusTaken
                                                }
                                            >
                                                {emailCheck.available
                                    ...
                                    <div>
                                        <Textfield
                                            ...
                                            aria-describedby={
                                                password.length > 0 ? passwordStrengthId : undefined
                                            }
                                        />
                                        {password.length > 0 && (
                                            <div className={regStyles.passwordMeterBlock}>
                                                <ProgressBar
                                                    ...
                                                    aria-label={t(
                                                        'web.register.passwordStrengthAria',
                                                        'Passordstyrke',
                                                    )}
                                                />
                                                <Paragraph
