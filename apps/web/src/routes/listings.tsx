      ...
      <div className={s.sectionInner}>
        <div className={s.sectionHeader}>
          <Heading level={2} className={s.sectionTitle}>
            {t('landing.whySwitch.title', 'Why Creators Are Switching')}
          </Heading>
        ...
        <div className={s.painGrid}>
          {PAIN_POINTS.map((pain) => (
            <div key={pain.id} className={s.painCard}>
              ...
              <Heading level={3} className={s.painCardTitle}>
                {t(pain.titleKey, pain.titleDefault)}
              </Heading>
  ...
  return (
    <section className={s.sectionAlt}>
      <div className={s.sectionInner}>
        <div className={s.sectionHeader}>
          <Heading level={2} className={s.sectionTitle}>
            {t('landing.tools.title', 'Professional Creator Tools')}
          </Heading>
          <Paragraph className={s.sectionSubtitle}>
        ...
        <div className={s.toolsGrid}>
          {TOOLS.map((tool) => (
            <div key={tool.id} className={s.toolCard}>
              ...
              <Heading level={3} className={s.toolTitle}>
                {t(tool.titleKey, tool.titleDefault)}
              </Heading>
  ...
  return (
    <section className={s.section}>
      <div className={s.sectionInner}>
        <div className={s.sectionHeader}>
          <Heading level={2} className={s.sectionTitle}>
            {t('landing.preview.title', 'See Your Business at a Glance')}
          </Heading>
          <Paragraph className={s.sectionSubtitle}>
            {t(
        ...
        <div className={s.previewContainer}>
          <div className={s.previewText}>
            <Heading level={3} className={s.previewTitle}>
              {t('landing.preview.dashboardTitle', 'Revenue Dashboard')}
            </Heading>
    ...
    <section className={s.sectionAlt}>
      <div className={s.sectionInner}>
        <div className={s.previewContainer}>
          ...
          <div className={s.previewText}>
            <Heading level={3} className={s.previewTitle}>
              {t('landing.commandCenter.title', 'Your Command Center')}
            </Heading>
            <Paragraph className={s.previewDesc}>
              {t(
  ...
  return (
    <section className={s.section}>
      <div className={s.sectionInner}>
        <div className={s.sectionHeader}>
          <Heading level={2} className={s.sectionTitle}>
            {t('landing.creators.title', 'Discover Top Creators')}
          </Heading>
          <Paragraph className={s.sectionSubtitle}>
            {t(
  ...
  return (
    <section className={s.sectionAlt}>
      <div className={s.sectionInner}>
        <div className={s.sectionHeader}>
          <Heading level={2} className={s.sectionTitle}>
            {t('landing.testimonials.title', 'What They Say')}
          </Heading>
        </div>
