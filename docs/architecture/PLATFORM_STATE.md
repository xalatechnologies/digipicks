...
Shared Packages
  ├── @digilist-saas/app-shell — 13 providers, 11 hooks, layout, auth guards
  ├── @digilist-saas/ds        — 66 components (Digdir Designsystemet)
  ├── @digilist-saas/shared    — 21 type modules, constants, navigation
  └── @digilist-saas/i18n      — nb, en, ar with RTL support
