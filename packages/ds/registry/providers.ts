 ...
 * Apps must use shared infrastructure from @digipicks/app-shell or @digipicks/sdk.
 *
...
export const providers: Record<string, ProviderInfo> = {
  ...
  designsystemetProvider: {
    ...
    package: '@digipicks/ds',
    description: 'Digdir Designsystemet provider for theme, size, typography. Use via @digipicks/ds.',
    order: 3,
