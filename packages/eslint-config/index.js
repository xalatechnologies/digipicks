/**
 * @digipicks/eslint-config - Shared ESLint configuration
 *
 ...
 * - xala/no-inline-svg: use @digipicks/ds Icon components
 * - xala/no-hardcoded-colors: no rgb/rgba/hex in style — use var(--ds-*)
 * - xala/no-direct-digdir: use @digipicks/ds or platform-ui
...
export const apps = [
  ...base,
  {
    ...
    rules: {
      ...
      // UI Guardrails: no direct @digdir imports — use @digipicks/ds or platform-ui
      ...
      // DS Standards: no inline SVG — use @digipicks/ds Icon components
      ...
      // Security Invariants: no app-local AuthProvider/useAuth — use @digipicks/app-shell
