 ...
 */
export function useCreatorDiscovery(tenantId: Id<'tenants'> | undefined, params?: UseCreatorDiscoveryParams) {
  const data = useConvexQuery(api.domain.picks.discoverCreators, tenantId ? { tenantId, ...params } : 'skip');
