...
export function useMyEarningsSummary(
    ...
    const data = useQuery(
        ...
        tenantId && userId
            ? { tenantId: tenantId as any, userId: userId as any }
            : "skip"
    );
...
export function useMyEarningsHistory(
    ...
    const data = useQuery(
        ...
        tenantId && userId
            ? { tenantId: tenantId as any, userId: userId as any, limit }
            : "skip"
    );
...
export function useMyPayouts(
    ...
    const data = useQuery(
        ...
        tenantId && userId
            ? { tenantId: tenantId as any, userId: userId as any, status, limit }
            : "skip"
    );
