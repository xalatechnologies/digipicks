    ...
    sections: [
      {
        items: [
          {
            id: 'dashboard',
            nameKey: 'minside.dashboard',
            descriptionKey: 'minside.dashboardDesc',
            href: '/',
            icon: 'home',
            contexts: ['personal', 'organization'],
          },
      ...
      },
      {
        ...
        items: [
          {
            id: 'billing',
            nameKey: 'minside.billing',
            descriptionKey: 'minside.billingDesc',
            href: '/billing',
            icon: 'creditCard',
            contexts: ['personal'],
          },
          {
            id: 'notifications',
            nameKey: 'minside.notifications',
            descriptionKey: 'minside.notificationsDesc',
            href: '/notifications',
            icon: 'message',
            contexts: ['personal', 'organization'],
          },
      ...
      },
      {
        ...
        items: [
          {
            id: 'settings',
            nameKey: 'minside.settings',
            descriptionKey: 'minside.settingsDesc',
            href: '/preferences',
            icon: 'settings',
            contexts: ['personal'],
          },
          {
            id: 'help',
            nameKey: 'minside.help',
            descriptionKey: 'minside.helpDesc',
            href: '/help',
            icon: 'bookOpen',
            contexts: ['personal', 'organization'],
          },
      ...
      },
      {
        ...
        items: [
          {
            id: 'org-dashboard',
            nameKey: 'org.dashboard',
            descriptionKey: 'org.dashboardDesc',
            href: '/org',
            icon: 'home',
          ...
          {
            id: 'org-invoices',
            nameKey: 'org.invoices',
            descriptionKey: 'org.invoicesDesc',
            href: '/org/invoices',
            icon: 'creditCard',
            contexts: ['organization'],
          },
          {
            id: 'org-members',
            nameKey: 'org.members',
            descriptionKey: 'org.membersDesc',
            href: '/org/members',
            icon: 'users',
            contexts: ['organization'],
          },
          {
            id: 'org-settings',
            nameKey: 'org.settings',
            descriptionKey: 'org.settingsDesc',
            href: '/org/settings',
            icon: 'settings',
            contexts: ['organization'],
          },
          {
            id: 'org-activity',
            nameKey: 'org.activity',
            descriptionKey: 'org.activityDesc',
            href: '/org/activity',
            icon: 'calendar',
            contexts: ['organization'],
          },
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          {
            id: 'listings',
            nameKey: 'backoffice.nav.listings',
            description: 'Administrer lokaler og utstyr',
            href: '/listings',
            icon: 'building',
            roles: ['superadmin', 'admin', 'user'],
            modes: ['utleier'],
          ...
          {
            id: 'form-builder',
            nameKey: 'backoffice.nav.formBuilder',
...

      {
        ...
        items: [
          {
            id: 'economy',
            nameKey: 'backoffice.nav.economy',
            description: 'Økonomi, fakturaer og rapporter',
            href: '/economy',
            icon: 'chart',
            roles: ['admin'],
          },
      ...
      },
      {
        ...
        items: [
          {
            id: 'reports',
            nameKey: 'backoffice.nav.reports',
          ...
          },
          {
            ...
            nameKey: 'backoffice.nav.paymentReconciliation',
            description: 'Avstem betalinger',
          ...
          {
            id: 'pricing-rules',
            nameKey: 'backoffice.nav.pricingRules',
            description: 'Administrer priser',
            href: '/pricing-rules',
            icon: 'settings',
            roles: ['admin', 'user'],
            modes: ['utleier'],
          },
          {
            ...
            nameKey: 'backoffice.nav.equipmentServices',
            description: 'Utstyr og tilleggstjenester',
          ...
          {
            id: 'innhold',
            nameKey: 'backoffice.nav.innhold',
            description: 'Innhold på lokaler',
            href: '/innhold',
            icon: 'fileText',
            roles: ['admin', 'user'],
            modes: ['utleier'],
      ...
      },
      {
        ...
        items: [
          {
            id: 'organizations',
            nameKey: 'backoffice.nav.organizations',
      ...
      },
      {
        ...
        items: [
          {
            id: 'integrations',
            nameKey: 'backoffice.nav.integrations',
            description: 'Tilkoblinger og APIer',
            href: '/integrations',
            icon: 'settings',
            roles: ['admin'],
          },
          {
            id: 'listing-wizard',
            nameKey: 'backoffice.nav.listingWizard',
            description: 'Opprett lokale',
            href: '/listings/wizard',
            icon: 'building',
            roles: ['admin', 'user'],
            modes: ['utleier'],
          },
          {
            id: 'tenant-settings',
            nameKey: 'backoffice.nav.tenantSettings',
            description: 'Konfigurer tenant',
          ...
          {
            id: 'tenant-branding',
            nameKey: 'backoffice.nav.tenantBranding',
          ...
          },
          {
            ...
            nameKey: 'backoffice.nav.reviewsModeration',
            description: 'Moderer anmeldelser',
          ...
          {
            id: 'reviews-integrations',
            nameKey: 'backoffice.nav.reviewsIntegrations',
            description: 'Google og TripAdvisor',
            href: '/reviews/integrations',
            icon: 'link',
            roles: ['admin'],
            module: 'reviews',
          },
      ...
      },
      {
        ...
        items: [
          {
            id: 'my-dashboard',
            nameKey: 'nav.myDashboard',
            description: 'Din personlige oversikt',
            href: '/',
            icon: 'home',
            roles: ['user'],
            modes: ['leietaker'],
          ...
          {
            id: 'my-billing',
            nameKey: 'nav.myBilling',
            description: 'Faktura og betaling',
            href: '/billing',
            icon: 'creditCard',
            roles: ['user'],
            modes: ['leietaker'],
      ...
      },
      {
        ...
        items: [
          {
            id: 'org-dashboard',
            nameKey: 'nav.orgDashboard',
            description: 'Organisasjonsoversikt',
            href: '/org',
            icon: 'building',
            roles: ['user'],
            contexts: ['organization'],
          ...
          {
            id: 'org-settings',
            nameKey: 'nav.orgSettings',
            description: 'Organisasjonsinnstillinger',
            href: '/org/settings',
            icon: 'settings',
            roles: ['user'],
            contexts: ['organization'],
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            nameKey: 'platform.nav.moderation',
          ...
          },
          {
            ...
            nameKey: 'platform.nav.applications',
            description: 'Søknader om utleiertilgang',
